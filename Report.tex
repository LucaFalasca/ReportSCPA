...
Per questioni di tempo non sono state applicate le soluzioni proposte in \cite{b1}, altre possibili soluzioni semplici sono utilizzare una block size size diversa o aggiungere del padding, anche se quest'ultima soluzione causa uno spreco di memoria che potrebbe non essere trascurabile.
\begin{figure}[H]
    \centering
