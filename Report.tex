...
Invece la versione 2 ha delle performance migliori rispetto alla versione 1, nonostante sarebbe dovuto essere un miglioramento. 
Questo strano comportamento potrebbe essere dovuto al fatto che la versione 2 ha un overhead maggiore di memoria rispetto alla versione 1 in quanto deve mantenere e una matrice ausiliaria dei risultati parziali più grandi e questo potrebbe avere un impatto maggiore rispetto al numero di sincronizzazioni in più che la versione 1 deve fare.\\
\begin{figure}[H]
    \centering
