...
Per questioni di tempo non sono state applicate le soluzioni proposte in \cite{b1}, una possibile soluzione semplice è inserire una riga ed una colonna di padding alle matrici originali, seppur semplice questa soluzione porta in caso di matrici grandi ad uno spreco di memoria che potrebbe non essere trascurabile.
\begin{figure}[H]
    \centering
...
Come è possibile vedere dai grafici anche in questo caso, seppur in maniera meno evidente, è presente il problema del \textit{critical stride}.
\begin{figure}[H]
    \centering
